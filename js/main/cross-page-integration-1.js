...
function setSelectedBoard(board) {
  ...
  window._selectedBoards = window._selectedBoards || {};
...
// Restore any previously-picked boards (if any) so their categories survive reloads
// We do this in a short timeout to ensure the Blockly workspace is fully injected and ready
setTimeout(function() {
  try {
